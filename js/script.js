...
const frases = [
  ...
  "Compilar no es magia, es solo transformar el código en algo que la máquina entienda... como minha abuela con español y portunhol.",
  ...
  "Quando o código no funciona, no é brujería… es só você que olvidou un ponto e vírgula. Mui simplis.",
...
botao.addEventListener('click', () => {
  ...
  if (fala.style.display === 'none' || !fala.style.display) {
    ...
    fala.textContent = fraseAleatoria;
